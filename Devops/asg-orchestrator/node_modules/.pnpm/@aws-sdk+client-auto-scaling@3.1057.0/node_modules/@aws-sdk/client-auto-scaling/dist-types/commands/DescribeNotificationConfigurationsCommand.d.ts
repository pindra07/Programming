...
import type { DescribeNotificationConfigurationsAnswer, DescribeNotificationConfigurationsType } from "../models/models_0";
/**
 * @public
 */
...
declare const DescribeNotificationConfigurationsCommand_base: {
    new (input: DescribeNotificationConfigurationsCommandInput): import("@smithy/core/client").CommandImpl<DescribeNotificationConfigurationsCommandInput, DescribeNotificationConfigurationsCommandOutput, AutoScalingClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DescribeNotificationConfigurationsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeNotificationConfigurationsCommandInput, DescribeNotificationConfigurationsCommandOutput, AutoScalingClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
