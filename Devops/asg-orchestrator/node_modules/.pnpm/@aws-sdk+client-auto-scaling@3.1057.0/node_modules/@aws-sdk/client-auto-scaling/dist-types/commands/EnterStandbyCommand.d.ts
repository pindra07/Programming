...
import type { EnterStandbyAnswer, EnterStandbyQuery } from "../models/models_0";
/**
 * @public
 */
...
declare const EnterStandbyCommand_base: {
    new (input: EnterStandbyCommandInput): import("@smithy/core/client").CommandImpl<EnterStandbyCommandInput, EnterStandbyCommandOutput, AutoScalingClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: EnterStandbyCommandInput): import("@smithy/core/client").CommandImpl<EnterStandbyCommandInput, EnterStandbyCommandOutput, AutoScalingClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
