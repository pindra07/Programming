...
import type { DescribeLifecycleHooksAnswer, DescribeLifecycleHooksType } from "../models/models_0";
/**
 * @public
 */
...
declare const DescribeLifecycleHooksCommand_base: {
    new (input: DescribeLifecycleHooksCommandInput): import("@smithy/core/client").CommandImpl<DescribeLifecycleHooksCommandInput, DescribeLifecycleHooksCommandOutput, AutoScalingClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DescribeLifecycleHooksCommandInput): import("@smithy/core/client").CommandImpl<DescribeLifecycleHooksCommandInput, DescribeLifecycleHooksCommandOutput, AutoScalingClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
