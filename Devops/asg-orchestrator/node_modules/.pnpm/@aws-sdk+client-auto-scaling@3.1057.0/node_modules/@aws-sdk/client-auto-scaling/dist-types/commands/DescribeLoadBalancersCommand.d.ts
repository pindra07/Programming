...
import type { DescribeLoadBalancersRequest, DescribeLoadBalancersResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const DescribeLoadBalancersCommand_base: {
    new (input: DescribeLoadBalancersCommandInput): import("@smithy/core/client").CommandImpl<DescribeLoadBalancersCommandInput, DescribeLoadBalancersCommandOutput, AutoScalingClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DescribeLoadBalancersCommandInput): import("@smithy/core/client").CommandImpl<DescribeLoadBalancersCommandInput, DescribeLoadBalancersCommandOutput, AutoScalingClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
