...
import type { DescribeScheduledActionsType, ScheduledActionsType } from "../models/models_0";
/**
 * @public
 */
...
declare const DescribeScheduledActionsCommand_base: {
    new (input: DescribeScheduledActionsCommandInput): import("@smithy/core/client").CommandImpl<DescribeScheduledActionsCommandInput, DescribeScheduledActionsCommandOutput, AutoScalingClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DescribeScheduledActionsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeScheduledActionsCommandInput, DescribeScheduledActionsCommandOutput, AutoScalingClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
