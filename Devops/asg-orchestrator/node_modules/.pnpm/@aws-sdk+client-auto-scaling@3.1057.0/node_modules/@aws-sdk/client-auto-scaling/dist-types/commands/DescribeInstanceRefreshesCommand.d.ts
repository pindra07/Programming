...
import type { DescribeInstanceRefreshesAnswer, DescribeInstanceRefreshesType } from "../models/models_0";
/**
 * @public
 */
...
declare const DescribeInstanceRefreshesCommand_base: {
    new (input: DescribeInstanceRefreshesCommandInput): import("@smithy/core/client").CommandImpl<DescribeInstanceRefreshesCommandInput, DescribeInstanceRefreshesCommandOutput, AutoScalingClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DescribeInstanceRefreshesCommandInput): import("@smithy/core/client").CommandImpl<DescribeInstanceRefreshesCommandInput, DescribeInstanceRefreshesCommandOutput, AutoScalingClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
