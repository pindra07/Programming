...
import type { PutWarmPoolAnswer, PutWarmPoolType } from "../models/models_0";
/**
 * @public
 */
...
declare const PutWarmPoolCommand_base: {
    new (input: PutWarmPoolCommandInput): import("@smithy/core/client").CommandImpl<PutWarmPoolCommandInput, PutWarmPoolCommandOutput, AutoScalingClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: PutWarmPoolCommandInput): import("@smithy/core/client").CommandImpl<PutWarmPoolCommandInput, PutWarmPoolCommandOutput, AutoScalingClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
