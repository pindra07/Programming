...
import type { LaunchConfigurationNamesType, LaunchConfigurationsType } from "../models/models_0";
/**
 * @public
 */
...
declare const DescribeLaunchConfigurationsCommand_base: {
    new (input: DescribeLaunchConfigurationsCommandInput): import("@smithy/core/client").CommandImpl<DescribeLaunchConfigurationsCommandInput, DescribeLaunchConfigurationsCommandOutput, AutoScalingClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DescribeLaunchConfigurationsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeLaunchConfigurationsCommandInput, DescribeLaunchConfigurationsCommandOutput, AutoScalingClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
