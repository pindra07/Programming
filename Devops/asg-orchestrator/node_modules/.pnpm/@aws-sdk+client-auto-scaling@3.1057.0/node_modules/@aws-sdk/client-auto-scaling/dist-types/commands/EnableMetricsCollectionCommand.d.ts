...
import type { EnableMetricsCollectionQuery } from "../models/models_0";
/**
 * @public
 */
...
declare const EnableMetricsCollectionCommand_base: {
    new (input: EnableMetricsCollectionCommandInput): import("@smithy/core/client").CommandImpl<EnableMetricsCollectionCommandInput, EnableMetricsCollectionCommandOutput, AutoScalingClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: EnableMetricsCollectionCommandInput): import("@smithy/core/client").CommandImpl<EnableMetricsCollectionCommandInput, EnableMetricsCollectionCommandOutput, AutoScalingClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
