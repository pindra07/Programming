...
import type { DescribeLoadBalancerTargetGroupsRequest, DescribeLoadBalancerTargetGroupsResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const DescribeLoadBalancerTargetGroupsCommand_base: {
    new (input: DescribeLoadBalancerTargetGroupsCommandInput): import("@smithy/core/client").CommandImpl<DescribeLoadBalancerTargetGroupsCommandInput, DescribeLoadBalancerTargetGroupsCommandOutput, AutoScalingClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DescribeLoadBalancerTargetGroupsCommandInput): import("@smithy/core/client").CommandImpl<DescribeLoadBalancerTargetGroupsCommandInput, DescribeLoadBalancerTargetGroupsCommandOutput, AutoScalingClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
