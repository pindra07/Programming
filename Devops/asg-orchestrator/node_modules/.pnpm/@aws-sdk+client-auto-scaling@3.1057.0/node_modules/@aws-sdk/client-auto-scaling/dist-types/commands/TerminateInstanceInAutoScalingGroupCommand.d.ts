...
import type { ActivityType, TerminateInstanceInAutoScalingGroupType } from "../models/models_0";
/**
 * @public
 */
...
declare const TerminateInstanceInAutoScalingGroupCommand_base: {
    new (input: TerminateInstanceInAutoScalingGroupCommandInput): import("@smithy/core/client").CommandImpl<TerminateInstanceInAutoScalingGroupCommandInput, TerminateInstanceInAutoScalingGroupCommandOutput, AutoScalingClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: TerminateInstanceInAutoScalingGroupCommandInput): import("@smithy/core/client").CommandImpl<TerminateInstanceInAutoScalingGroupCommandInput, TerminateInstanceInAutoScalingGroupCommandOutput, AutoScalingClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
