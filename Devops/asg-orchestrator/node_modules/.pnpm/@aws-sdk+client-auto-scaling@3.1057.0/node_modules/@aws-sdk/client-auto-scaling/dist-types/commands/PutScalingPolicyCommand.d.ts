...
import type { PolicyARNType, PutScalingPolicyType } from "../models/models_0";
/**
 * @public
 */
...
declare const PutScalingPolicyCommand_base: {
    new (input: PutScalingPolicyCommandInput): import("@smithy/core/client").CommandImpl<PutScalingPolicyCommandInput, PutScalingPolicyCommandOutput, AutoScalingClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: PutScalingPolicyCommandInput): import("@smithy/core/client").CommandImpl<PutScalingPolicyCommandInput, PutScalingPolicyCommandOutput, AutoScalingClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
