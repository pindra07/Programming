...
declare const DescribeTrafficSourcesCommand_base: {
    new (input: DescribeTrafficSourcesCommandInput): import("@smithy/core/client").CommandImpl<DescribeTrafficSourcesCommandInput, DescribeTrafficSourcesCommandOutput, AutoScalingClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: DescribeTrafficSourcesCommandInput): import("@smithy/core/client").CommandImpl<DescribeTrafficSourcesCommandInput, DescribeTrafficSourcesCommandOutput, AutoScalingClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
