...
import type { DescribeAdjustmentTypesAnswer } from "../models/models_0";
/**
 * @public
 */
...
declare const DescribeAdjustmentTypesCommand_base: {
    new (input: DescribeAdjustmentTypesCommandInput): import("@smithy/core/client").CommandImpl<DescribeAdjustmentTypesCommandInput, DescribeAdjustmentTypesCommandOutput, AutoScalingClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DescribeAdjustmentTypesCommandInput]): import("@smithy/core/client").CommandImpl<DescribeAdjustmentTypesCommandInput, DescribeAdjustmentTypesCommandOutput, AutoScalingClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
