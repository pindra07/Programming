...
import type { AutoScalingInstancesType, DescribeAutoScalingInstancesType } from "../models/models_0";
/**
 * @public
 */
...
declare const DescribeAutoScalingInstancesCommand_base: {
    new (input: DescribeAutoScalingInstancesCommandInput): import("@smithy/core/client").CommandImpl<DescribeAutoScalingInstancesCommandInput, DescribeAutoScalingInstancesCommandOutput, AutoScalingClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DescribeAutoScalingInstancesCommandInput]): import("@smithy/core/client").CommandImpl<DescribeAutoScalingInstancesCommandInput, DescribeAutoScalingInstancesCommandOutput, AutoScalingClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
